...
function ControlPanelRoutes({ pathname, view }: ControlPanelTypes) {
  ...
  const navigationLinks = [
    ...
    {
      href: baseRoute + ROUTES.CONTROL_PANEL_SUBROUTES.TOURNAMENTS,
      label: 'Tournaments',
      icon: tournamentsIcon,
      withSeasonParam: false,
      access: hasPageAccess(ControlPanelLeaguePages.TOURNAMENTS),
    },
    {
...
const tournamentsIcon = (
  ...
  >
    <path
      ...
      strokeLinejoin='round'
      strokeWidth='1.5'
      d='M3 3h5v6H3m5-3h7v12H8m7-6h7M3 15h5v6H3'
    ></path>
  </svg>
);
